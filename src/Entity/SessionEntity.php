...
use Whitehatsleague\OAuth2\Server\Event\SessionOwnerEvent;
...
class SessionEntity
{
     ...
     * Client identifier
     *
     * @var \Whitehatsleague\OAuth2\Server\Entity\ClientEntity
     */
    protected $client;
     ...
     * Auth code
     *
     * @var \Whitehatsleague\OAuth2\Server\Entity\AuthCodeEntity
     */
    protected $authCode;
     ...
     * Refresh token
     *
     * @var \Whitehatsleague\OAuth2\Server\Entity\RefreshTokenEntity
     */
     ...
     *
     * @var \Whitehatsleague\OAuth2\Server\AuthorizationServer|\Whitehatsleague\OAuth2\Server\ResourceServer
     */
    protected $server;
     ...
     * Associate a scope
     *
     * @param \Whitehatsleague\OAuth2\Server\Entity\ScopeEntity $scope
     *
     * @return self
     */
     ...
     *
     * @param  \Whitehatsleague\OAuth2\Server\Entity\Scope[]
     *
     * @return array
     */
     ...
     *
     * @param \Whitehatsleague\OAuth2\Server\Entity\AccessTokenEntity $accessToken
     *
     * @return self
     */
     ...
     *
     * @param \Whitehatsleague\OAuth2\Server\Entity\RefreshTokenEntity $refreshToken
     *
     * @return self
     */
     ...
     *
     * @param \Whitehatsleague\OAuth2\Server\Entity\ClientEntity $client The client
     *
     * @return self
     */
